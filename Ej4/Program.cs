                 ...
                 out3:
                    ...
                    switch (opcion)
                    {
                        case "1":
                            ...
                            Console.WriteLine("La suma es: {0}", auxCom);
                            Console.ReadKey();
                            goto out3;
                        ...
                        case "2":
                            ...
                            auxCom = hola.Restar(auxCom2);
                            Console.WriteLine("La resta es: {0}", auxCom2);
                            Console.ReadKey();
                            goto out3;
                        ...
                        case "3":
                            ...
                            Console.WriteLine("La multiplicacion es: {0}", auxCom3);
                            Console.ReadKey();
                            goto out3;
                        ...
                        case "4":
                            ...
                            Console.WriteLine("La division es: {0}", auxCom4);
                            Console.ReadKey();
                            goto out3;
